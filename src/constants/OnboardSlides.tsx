const slides = [
  ...
  },
  {
    ...
    title: 'Contacto',
    subtitle:
      'Estoy abierto a nuevas propuestas tecnológicas. Si deseas ponerte en contacto conmigo puedes hacerlo a través de mi correo electrónico dunapanta@outlook.es',
  },
];
